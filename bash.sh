...
sed -i 's|export KEY_PROVINCE="CA"|export KEY_PROVINCE="QUE"|' /etc/openvpn/easy-rsa/vars
...
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="pagebook.kev@gmail.com"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="kevinbeetle"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="kevinbeetle"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=kevinbeetle|' /etc/openvpn/easy-rsa/vars
