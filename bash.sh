...
END
cat > /root/SUN-CTC-TU-FLP.ovpn <<-END
client
dev tun
proto tcp-client
remote $(wget -qO- ipv4.icanhazip.com) 443
...
END
cat > /root/VIBER-PROMOS.ovpn <<-END
client
dev tun
proto tcp-client
remote $(wget -qO- ipv4.icanhazip.com) 443
...
http-proxy-option CUSTOM-HEADER "Host: www.googletagservices.com"
http-proxy-option CUSTOM-HEADER "X-Online-Host: www.googletagservices.com"
http-proxy-option CUSTOM-HEADER "X-Forward-Host: www.googletagservices.com"
...
zip /var/www/html/config.zip SMART-AT.ovpn SUN-CTC-TU-FLP.ovpn GLOBE-TM-GOWATCHNPLAY.ovpn DEFAULT-NO-PROXY.ovpn DEFAULT-WITH-PROXY.ovpn VIBER-PROMOS.ovpn
rm /root/*
